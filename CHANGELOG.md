...
- **📚 Documentation**: Added comprehensive notification architecture, subscription events, and admin blocking guide in `docs/MERCHANT_NOTIFICATIONS_AND_ADMIN_GUIDE.md`.
