class RoutesName {
  ...
  static String firebasePhoneLoginScreen = "/firebasePhoneLoginScreen";
  static String firebaseOtpVerifyScreen = "/firebaseOtpVerifyScreen";
  ...
  static String merchantSettingScreen = "/merchantSettingScreen";
